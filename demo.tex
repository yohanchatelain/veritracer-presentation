...
\titlegraphic{\includegraphics[height=1cm]{Logo-Exascale.png}}
...
\begin{figure}
\only<1>{\includegraphics[width=\linewidth]{muller.png}}
\only<2>{\includegraphics[width=\linewidth]{muller_2.png}}
\end{figure}
...
\begin{figure}
\vspace{-0.25cm}
\noindent\includegraphics[width=\linewidth]{veritracer_workflow_line2_dash.png}
...
% \only<1>{\includegraphics[width=\linewidth]{context.png}}
% \only<2>{\includegraphics[width=\linewidth]{context_CSP1.png}}
% \only<3>{\includegraphics[width=\linewidth]{context_CSP2.png}}
% \end{minipage}
% \end{frame}
...
% \end{minipage}
% \hspace{.25cm}\begin{minipage}{0.4\linewidth}
% \only<1>{\includegraphics[width=.9\linewidth]{control.pdf}}
% \only<2>{\includegraphics[width=.9\linewidth]{control_path1.pdf}}
% \only<3>{\includegraphics[width=.9\linewidth]{control_path2.pdf}}
% \end{minipage}
% \end{frame}
...
% \end{minipage}
% \hspace{.25cm}\begin{minipage}{0.4\linewidth}
% \only<1>{\includegraphics[width=.9\linewidth]{dataflow.pdf}}
% \only<2>{\includegraphics[width=.9\linewidth]{dataflow_red.pdf}}
% \only<3>{\includegraphics[width=.9\linewidth]{dataflow_blue.pdf}}
% \only<4>{\includegraphics[width=.9\linewidth]{dataflow_violet.pdf}}
% \end{minipage}
% \end{frame}
...
% \end{alertblock}
% \begin{figure}
% \only<1>{\includegraphics[width=.75\linewidth, height=5cm]{ordering.png}}
% \only<2>{\includegraphics[width=.75\linewidth, height=5cm]{ordering_simp_gen.png}}
% \end{figure}
% \end{frame}
